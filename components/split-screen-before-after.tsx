          ...
          <div className="grid lg:grid-cols-[40%_1fr] gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-orange-100 to-red-100 border border-orange-200 mb-4">
                <span className="text-orange-600 font-semibold text-sm uppercase tracking-wide">Clutch by xo-link</span>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              >
                ...
                <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                  Clutch by xo-link handles all your WhatsApp, Messenger, and Instagram DM conversations automatically.
                        ...
                        <div className="bg-slate-800/50 rounded-xl p-2 sm:p-3 lg:p-4 border border-slate-700/50">
                          ...
                          <div className="space-y-2 lg:space-y-3 text-[8px] sm:text-[9px] lg:text-xs">
                            <div className="bg-slate-900/50 rounded-lg p-2 border-l-2 border-orange-500">
                              <div className="text-orange-400 font-semibold mb-0.5">xo-link</div>
              ...
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                >
                  ...
                  <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                    ...
                    website, phone, and social media. Clutch By xo-link manages bookings, answers parts questions, and
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        Clutch By xo-link automatically schedules service appointments and sends confirmations across all
                ...
                >
                  ...
                  <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                    Stop wasting time on repetitive questions. Clutch By xo-link instantly answers common inquiries about
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        Clutch By xo-link responds to 50+ common questions about NCT, mileage, trade-ins, and pricing
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        Stop answering the same questions repeatedly - let Clutch By xo-link handle the tire kickers
                      </p>
                    </div>
