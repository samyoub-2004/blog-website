      ...
      <div className="bg-white rounded-b-[3rem] pt-16 sm:pt-24 pb-16 sm:pb-24 px-4 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            >
              Watch how our websites transform businesses. From boutique stores to high-performing ecommerce platforms, we deliver results.
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 max-w-7xl mx-auto">
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center lg:h-[600px] space-y-6 lg:space-y-8 order-2 lg:order-1">
              <div
                className={`relative h-64 lg:h-96 rounded-2xl overflow-hidden transition-all duration-1000 delay-700 ${
